...
# IP: bd/system/ip/system_axi_aes_0_0/system_axi_aes_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_axi_aes_0_0 || ORIG_REF_NAME==system_axi_aes_0_0} -quiet] -quiet

# IP: bd/system/ip/system_axi_hmac_0_0/system_axi_hmac_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_axi_hmac_0_0 || ORIG_REF_NAME==system_axi_hmac_0_0} -quiet] -quiet
